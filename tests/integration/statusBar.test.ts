...
suite('Status Bar', () => {
  ...
  test('No base selected → status bar text contains "Select base"', () => {
  ...
  test('Branch base → text contains branch name with git-branch icon', () => {
  ...
  test('Tag base → text contains tag name with tag icon', () => {
  ...
  test('Commit base → text contains commit hash with commit icon', () => {
  ...
  test('Long label (>30 chars) → truncated with ellipsis', () => {
  ...
  test('PR base → text uses github icon and PR number', () => {
  ...
  test('Status bar click command = taskChanges.selectBase with SCM arg', () => {
  ...
  test('Single repo → status bar always visible', () => {
    provider.showStatusBar()
    assert.strictEqual(provider.statusBarVisible, true)
  })

  test('Label that does not match PR #N → shown without github icon', () => {
  ...
  suite('Multi-repo status bar', () => {
    ...
    test('No active editor → both status bars visible', async () => {
    ...
    test('Active editor belongs to repo A → A visible', async () => {
