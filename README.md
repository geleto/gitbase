...
A VSCode extension that shows working-tree changes in the Source Control panel relative to a selected Git branch, commit, tag, or GitHub Pull Request - presented just like the familiar git Changes view, so the entire task remains visible across multiple commits.
